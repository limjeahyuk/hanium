...
import classes from './BuyWrite.module.css';
...
const BuyWrite = () => {
  ...
  return (
    <div>
      <Subheader />
      <form className={classes.writebox} onSubmit={submitHandler}>
        <div className={classes.condition}>
          <h3>재능사기 조건</h3>
          <div className={classes.boxbar}></div>
          ...
          <div className={classes.buypostbox}>
            <h3>모집내용</h3>
            <div className={classes.boxbar}></div>
        ...
        <button type='submit' /*촬영용 */ onClick={clickHandler}>
          등록하기
        </button>
      </form>
      <Footer />
